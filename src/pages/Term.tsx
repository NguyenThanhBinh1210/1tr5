const Term = () => {
  return (
    <div className='max-w-[1024px] bg-white mx-auto p-3 pb-20'>
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Term Of Service</h1>
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Terms and Conditions</h1>
      <p className='text-gray-700 mb-4'>Welcome to pro.masboyke.com!</p>
      <p className='text-gray-700 mb-4'>
        These terms and conditions outline the rules and regulations for the use of pro.masboyke.com’s Website, located
        at https://pro.masboyke.com.
      </p>
      <p className='text-gray-700 mb-4'>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use
        pro.masboyke.com if you do not agree to take all of the terms and conditions stated on this page.
      </p>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Cookies</h1>
      <p className='text-gray-700 mb-4'>
        We employ the use of cookies. By accessing pro.masboyke.com, you agreed to use cookies in agreement with the
        pro.masboyke.com’s Privacy Policy.
      </p>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>License</h1>
      <p className='text-gray-700 mb-4'>
        Unless otherwise stated, pro.masboyke.com and/or its licensors own the intellectual property rights for all
        material on pro.masboyke.com. All intellectual property rights are reserved. You may access this from
        pro.masboyke.com for your own personal use subjected to restrictions set in these terms and conditions.
      </p>
      <p className='text-gray-700 mb-4'>You must not:</p>
      <ul className='list-disc ml-10 mb-4'>
        <li className='text-gray-700'>Republish material from pro.masboyke.com</li>
        <li className='text-gray-700'>Sell, rent or sub-license material from pro.masboyke.com</li>
        <li className='text-gray-700'>Reproduce, duplicate or copy material from pro.masboyke.com</li>
        <li className='text-gray-700'>Redistribute content from pro.masboyke.com</li>
      </ul>
      <p className='text-gray-700 mb-4'>This Agreement shall begin on the date hereof.</p>
      <p className='text-gray-700 mb-4'>
        Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. pro.masboyke.com does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of pro.masboyke.com,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, pro.masboyke.com shall not be liable for the Comments or for any liability, damages or
        expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
        this website.
      </p>
      <p className='text-gray-700 mb-4'>
        pro.masboyke.com reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p className='text-gray-700 mb-4'>
        You hereby grant pro.masboyke.com a non-exclusive license to use, reproduce, edit and authorize others to use,
        reproduce and edit any of your Comments in any and all forms, formats or media.
      </p>
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Hyperlinking to our Content</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <ul className='list-disc ml-10 mb-4'>
        <li className='text-gray-700'>commonly-known consumer and/or business information sources;</li>
        <li className='text-gray-700'>dot.com community sites;</li>
        <li className='text-gray-700'>associations or other groups representing charities;</li>
        <li className='text-gray-700'>online directory distributors;</li>
        <li className='text-gray-700'>internet portals;</li>
        <li className='text-gray-700'>accounting, law and consulting firms; and</li>
        <li className='text-gray-700'>educational institutions and trade associations.</li>
      </ul>
      <p className='text-gray-700 mb-4'>
        ...
        pro.masboyke.com; and (d) the link is in the context of general resource information.
      </p>
      <p className='text-gray-700 mb-4'>
      ...
      <p className='text-gray-700 mb-4'>
        ...
        you must inform us by sending an e-mail to pro.masboyke.com. Please include your name, your organization name,
      ...
      <ul className='list-disc ml-10 mb-4'>
        <li className='text-gray-700'>By use of our corporate name; or</li>
        <li className='text-gray-700'>dot.com community sites;</li>
        <li className='text-gray-700'>By use of the uniform resource locator being linked to; or</li>
        <li className='text-gray-700'>
      ...
      <p className='text-gray-700 mb-4'>
        No use of pro.masboyke.com’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>iFrames</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Content Liability</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Reservation of Rights</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Removal of links from our website</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <h1 className='text-gray-700 text-2xl font-bold mb-4'>Disclaimer</h1>
      <p className='text-gray-700 mb-4'>
      ...
      <ul className='list-disc ml-10 mb-4'>
        <li className='text-gray-700'>limit or exclude our or your liability for death or personal injury;</li>
        <li className='text-gray-700'>
